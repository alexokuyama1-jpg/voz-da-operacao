...
const DB = (function () {
  ...
  function seed() {
    ...
    return {
      ...
      log_themes: [
        { id: 't1',  label: 'Limpeza',       icon: '🧹', cd: 'CD Carambeí', supervisor_id: 'u5', active: true },
        { id: 't2',  label: 'Organização',   icon: '📦', cd: 'CD Carambeí', supervisor_id: 'u5', active: true },
        { id: 't3',  label: 'Equipamentos',  icon: '🔧', cd: 'CD Carambeí', supervisor_id: 'u6', active: true },
        { id: 't4',  label: 'Segurança',     icon: '🛡️', cd: 'CD Carambeí', supervisor_id: 'u6', active: true },
        { id: 't5',  label: 'Manutenção',    icon: '🔨', cd: 'CD Carambeí', supervisor_id: 'u6', active: true },
        { id: 't6',  label: 'Comunicação',   icon: '📢', cd: 'CD Carambeí', supervisor_id: 'u5', active: true },
        { id: 't7',  label: 'Abastecimento', icon: '🚛', cd: 'CD Carambeí', supervisor_id: 'u5', active: true },
        { id: 't8',  label: 'Limpeza',       icon: '🧹', cd: 'CD Curitiba', supervisor_id: 'u7', active: true },
        { id: 't9',  label: 'Equipamentos',  icon: '🔧', cd: 'CD Curitiba', supervisor_id: 'u7', active: true },
        { id: 't10', label: 'Segurança',     icon: '🛡️', cd: 'CD Curitiba', supervisor_id: 'u7', active: true },
        { id: 't11', label: 'Limpeza',       icon: '🧹', cd: 'CD Londrina', supervisor_id: 'u8', active: true },
        { id: 't12', label: 'Equipamentos',  icon: '🔧', cd: 'CD Londrina', supervisor_id: 'u8', active: true },
        { id: 't13', label: 'Segurança',     icon: '🛡️', cd: 'CD Londrina', supervisor_id: 'u8', active: true },
      ],
